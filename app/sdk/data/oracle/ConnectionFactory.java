...
public class ConnectionFactory extends sdk.data.DataConnectionFactory {

    @Override
    @SuppressWarnings("unchecked")
    public sdk.data.oracle.OracleRepository ExecuteQuery(final DataService service) throws Exception {
        // --------------------------------------------------------------------
        Object result = Execute(service, new play.libs.F.Function<CallableStatement, Object>() {
            ...
            public Object apply(CallableStatement cs) throws Throwable {
                ...
                for (int i = 0; i < service.getParameters().size(); i++) {
                    sdk.data.DataParameter parameter = service.getParameters().get(i);
        ...
        return new sdk.data.oracle.OracleRepository((ArrayList<ResultSet>) result);
        // --------------------------------------------------------------------
    }
...
//            throw new valentys.exceptions.FrameworkException(3300, parameter.getName(), ex.getMessage());

...
public class DefaultEntityRepository extends EntityRepository {
    ...
    public void BoxValue(String classname, String columnName, Object nodeValue, Type databaseType, Type fieldType, Method methodInvoker, Object entity) throws Exception {
        ...
        try {
            ...
            //throw new nazca.exceptions.FrameworkException(6200, columnName, fieldType.toString());
        ...
        try {
            ...
            //throw new nazca.exceptions.FrameworkException(3000, classname, columnName, fieldType, databaseType, ex.getMessage(), ex.getClass().getSimpleName());
